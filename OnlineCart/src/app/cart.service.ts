...
export class CartService {
  ...
  myApiCallCartView(userEmail:any) {
    ...
    let urlstart = 'http://localhost:8080/onlinecart-1.0/onlinecart/cart/view?';
  ...
  myApiCallUpdateProductQuantity(cartId: any, productId: any, productQuantity: any) {
    ...
    let header= new HttpHeaders({})
    let urlstart='http://localhost:8181/onlinecart-1.0/onlinecart/cart/updateproductquantity?';
  ...
  myApiCallAddProductToCart(cartId: any, productId: any) {
    ...
    let header= new HttpHeaders({})
    let urlstart='http://localhost:8080/onlinecart-1.0/onlinecart/product/addtocart?';
  ...
  myApiCallRemoveItem(cartId: any, productId: any) {
    ...
    console.log("cartId:"+cartId+", productIds:"+productId);
    let header= new HttpHeaders({})
    let urlstart='http://localhost:8080/onlinecart-1.0/onlinecart/cart/removeproducts?';
  ...
  myApiCallRemoveAllItems(cartId: any) {
    ...
    let header= new HttpHeaders({})
    let urlstart='http://localhost:8080/onlinecart-1.0/onlinecart/cart/removeallproducts?';
  ...
  myApiCallBuyItem(userId: any, cartId: any, productId: any, productQuantity: any) {
    ...
    console.log("cartId:"+cartId+", productIds:"+productId);
    let header= new HttpHeaders({})
    let urlstart='http://localhost:8080/onlinecart-1.0/onlinecart/cart/createproductorder?';
  ...
  myApiCallBuyAllItems(userId: any, cartId: any) {
    ...
    console.log("cartId:"+cartId);
    let header= new HttpHeaders({})
    let urlstart='http://localhost:8080/onlinecart-1.0/onlinecart/cart/createorder?';
